...
const Activity = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-1 pb-[56px] md:pb-0">
      <ActivityHeader />
      <HeroBanner />
      ...
      <section className="max-w-[1280px] mx-auto px-4 md:px-8 py-8">
        ...
        <p className="text-ds-1 font-normal md:text-ds-3 md:font-bold text-neutral-7">{t('hero.description')}</p>
      </section>
